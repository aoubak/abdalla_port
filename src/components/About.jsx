    ...
    <section className=" ">
      ...
      <div className="container mx-auto p-2 md:px-14">
        ...
        <div className="bg-neutral-800 border-1 border-neutral-500/35 rounded-2xl p-8">
          <div className="">
            <span className="bg-neutral-700/75 ml-4 float-right p-2 rounded-md flex items-center justify-center h-[48px] w-[48px]">
            <MessageCircleWarning size={54} className="text-cyan-500" />
          </span>
            <p className="text-justify text-sm  flex">
          ...
          <div className="mt-4 flex flex-row items-start space-y-2 justify-start md:flex-row space-x-3">
